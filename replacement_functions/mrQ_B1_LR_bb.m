...
if ( mrQ.B1fit_done==0)
    ...
    if ( mrQ.SPGR_EPI_align_done==0)
        ...
        [mrQ.Ants_Info]=mrQ_SPM_reg_SPGR2EPI(mrQ.SEIRfits{AlignNum}.SEIR_epi_T1file,mrQ.LinFit.T1_LFit_HM,SPGR_niiFile_FA,B1_epi_OutPutDir,mrQ.spgr2epiAlignFile,AligndSPGR,mrQ.Ants_Info);
    ...
    [mrQ.maskepi_File] = mrQ_B1FitMask_bb([],mrQ.spgr2epiAlignFile,mrQ.SEIRfits{AlignNum}.SEIR_epi_fitFile,B1_epi_OutPutDir);%,mrQ.Ants_Info.WARP_SPGR_EPI);
...
if (mrQ.B1Build_done==0 && mrQ.B1fit_done==1)
    ...
    % have no fits.
    %the empty places are for soothnes value, default is 5
