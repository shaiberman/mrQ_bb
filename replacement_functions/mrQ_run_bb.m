function mrQ_run_bb(dir,outDir,inputData_spgr,inputData_seir,B1file, varArgIn)
...
if ~notDefined('varArgIn')
    if ~isempty(varArgIn)
        for ii = 1:2:numel(varArgIn)-1
            ...
            mrQ = mrQ_Set_bb(mrQ, varArgIn{ii}, varArgIn{ii+1});
        end
    end
end
...
if (mrQ.SPGR_LinearT1fit_done==0);
    ...
    [mrQ.LinFit]=mrQfit_T1M0_Lin_bb(mrQ,mrQ.InitSPGR.spgr_initDir);
