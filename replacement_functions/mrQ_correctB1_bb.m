function mrQ=mrQ_correctB1_bb(mrQ,B1fileName, T1app,T1_GS,outDir)
...
%% find the calibration value of B1
    ...
    seirBM=readFileNifti(BM_GS);
       seirBM=logical(seirBM.data) & seirT1.data<2500 & seirT1.data>1500;
%      seirBM=logical(seirBM.data) & seirT1.data<1500 & seirT1.data>700;
    ...
    spgrBM=logical(spgrBM.data) & spgrT1.data<2.5 & spgrT1.data>1.5;
